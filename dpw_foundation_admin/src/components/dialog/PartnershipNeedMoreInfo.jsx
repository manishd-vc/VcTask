...
export default function PartnershipNeedMoreInfo({ open, onClose, stageType, data, backTo }) {
  ...
  const { mutate: deleteMediaMutation, isLoading: isDeleteLoading } = useMutation(
    'deleteMedia',
    partnerManagementApi.deleteNeedMoreInfoDocuments,
    {
      onSuccess: (response) => {
  ...
  const { mutate, isLoading, isSuccess } = useMutation(partnerManagementApi.uploadNeedMoreInfoDocuments, {
    onSuccess: (response) => {
  ...
  const { mutate: partnerCommonStatusUpdate, isLoading: isPartnerCommonStatusUpdateLoading } = useMutation(
    ...
    <Dialog aria-label="Upload-documents" onClose={onClose} open={open} maxWidth={'md'}>
      ...
      <Formik
        ...
        onSubmit={(values) => {
          ...
          partnerCommonStatusUpdate({ id: data?.id, payload });
        }}
      >
            ...
            <Form id="needMoreInfoForm">
              ...
              <DialogActions>
                ...
                <LoadingButton
                  ...
                  loading={isPartnerCommonStatusUpdateLoading}
                  disabled={!dirty}
                >
                  Send
                </LoadingButton>

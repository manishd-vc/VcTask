    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent>
        <Typography variant="body2">
          Thank you for volunteering to help with the DP World Foundation in {volunteerCampaignTitle}. Please read,
          complete, and sign the following form to participate in this campaign.
        </Typography>
        <Typography
          variant="subtitle4"
          color="text.black"
        ...
        <Grid container spacing={3} sx={{ mb: 3 }}>
          <Grid item xs={12}>
            <Typography variant="body2">
              <div dangerouslySetInnerHTML={{ __html: templateData || 'No waiver content available' }} />
            </Typography>
          </Grid>
        </Grid>
      </DialogContent>

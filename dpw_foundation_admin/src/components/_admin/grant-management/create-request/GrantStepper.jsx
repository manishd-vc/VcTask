...
import GrantStep1 from './GrantStep1';
import GrantStep2 from './GrantStep2';
import GrantStep3 from './GrantStep3';

export default function GrantStepper() {
  ...
  return (
    <Steppers stepCount={0} activeStep={activeStep} steps={['Step One', 'Step Two', 'Step Three']}>
      <Paper sx={{ p: 3, mt: 2, mb: 3 }}>
        {activeStep === 0 && <GrantStep1 />}
        {activeStep === 1 && <GrantStep2 />}
        {activeStep === 2 && <GrantStep3 />}
      </Paper>

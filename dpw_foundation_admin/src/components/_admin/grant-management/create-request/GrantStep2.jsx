...
export default function GrantStep2() {
  ...
  const requestSourceData = getLabelObject(masterData, 'dpwf_grant_request_source');
  ...
  return (
    <>
      ...
      <AddDocument refetch={refetchDocumentsList} documentsList={documentsList} type="grant" />
      <DpWorldInfo />
    </>
  );
}

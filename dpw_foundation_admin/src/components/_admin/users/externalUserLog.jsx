...
export default function ExternalUserLogHistoryList() {
  ...
  const { isLoading } = useQuery(
    ...
    () => api.getExtUserLogHistory({ id: params?.id, page: +pageParam || 1, rows: +rowsParam || 10, sort: '' }), // API call to fetch log history
    {

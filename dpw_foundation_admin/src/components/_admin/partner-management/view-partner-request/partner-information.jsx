...
export default function PartnerInformation() {
  ...
  const profileDetails = [
    ...
    {
      label: 'Organization Contact Person First Name',
      value: firstName,
      textTransform: 'capitalize'
    },
    {
      label: 'Organization Contact Person Second Name',
      value: lastName,
      textTransform: 'capitalize'
    },
    { label: 'Organization Contact Person Phone Number', value: mobile },
    { label: 'Organization Name', value: organizationName },
    { label: 'Organization Registration Number', value: organizationRegistrationNumber },
    { label: 'Organization Country Where Registered', value: countryName },
    { label: 'Organization State Where Registered', value: stateName },
    { label: 'Organization City Where Registered', value: city },

...
import VolunteerCampaignsRow from 'src/components/table/rows/volunteerCampaignsRow';
...
const TABLE_HEAD = [
  ...
  { id: 'location', label: 'Location', alignRight: false, sort: true },
  { id: 'startDate', label: 'Start Date', alignRight: false, sort: true },
  { id: 'endDate', label: 'End Date', alignRight: false, sort: true },
  { id: 'noOfVolunteersRequired', label: 'No. of Volunteers Required', alignRight: false, sort: true },
  { id: 'noOfVolunteersEnrolled', label: 'No. of Volunteers Enrolled', alignRight: false, sort: true },
  { id: 'status', label: 'Status', alignRight: false, sort: true },
  { id: 'action', label: 'Actions', alignRight: true }
];

export default function VolunteerCampaignsListing() {
  ...
  const volunteerStatus = getLabelObject(masterData, 'dpwf_volunteer_status');
  ...
  const { mutate: exportMutate } = useMutation('export-volunteer-campaigns', volunteerApi.exportVolunteerCampaigns, {
    onSuccess: (data) => {
  ...
  const { isLoading, isFetching, refetch } = useQuery(
    ...
    () =>
      volunteerApi.getVolunteerCampaigns({
        page: +pageParam,
        rows: +rowsParam,
        search: searchParam || '',
        status: statusParams || '',
  ...
  return (
    <Table
      ...
      row={VolunteerCampaignsRow}
      totalCountText="All Volunteer Campaigns"

...
TableSearchFilterBar.propTypes = {
...
export default function TableSearchFilterBar({ filters = [], ...props }) {
  const { isSearch, isDatePicker, setFromDate, setToDate, dateValues, maxDate } = props;

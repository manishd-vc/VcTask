import ProjectsApproval from 'src/components/_admin/campaign-approval/projects';

// Meta information
export const metadata = {
  title: 'DP World Foundation - Projects Supervision',
  description:
...
export default function page() {
  return <ProjectsApproval isSupervisor />;
}

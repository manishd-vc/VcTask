import FinanceGrantRequest from 'src/components/_admin/finance-management/grant-request';

// Meta information
export const metadata = {
  title: 'DP World Foundation - Grant Requests',
  description:

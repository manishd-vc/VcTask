import AssessmentMain from 'src/components/_admin/donor/assessment';
export const metadata = {
  title: 'DP World Foundation - Assessment Operations',
  description:
...
export default function page() {
  return <AssessmentMain donorType="assessment" />;
}

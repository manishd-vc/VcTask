import OnTheSpotDonationMain from 'src/components/_admin/donor/onTheSpotDonationMain';

// Meta information
export const metadata = {
  title: 'DP World Foundation - On Site Donation',
  description:

...
// Meta information for the Register page
export const metadata = {
  title: 'Register| DP World Foundation',
  description:
 ...
 *
 * The Register page is protected by the GuestGuard, which ensures that only users who are not logged in can access it.
 * It renders the main registration form for users to create an account with DPW Foundation.
 *

// guard
import MakeDonationMain from 'src/components/_main/auth/makeDonation';
import GuestGuard from 'src/guards/guest';
// components

// Meta information
export const metadata = {
  title: 'Make a Donation | DP World Foundation',
  description:
 ...
 */
export default function MakeDonation({ searchParams }) {
  const token = searchParams.token;
  return <GuestGuard>{token && <MakeDonationMain token={token} />}</GuestGuard>;
}

import DonationAccept from 'src/components/_admin/my-donations/donationAccept';
 ...
 *
 * This page renders the donation management section of the DPW Foundation Dashboard.
 * The `Donation` component is used with the `isView` prop set to `true`, indicating that
 * this view is for viewing donation details, not for managing them.
 */
export default function page() {
  return <DonationAccept />;
}

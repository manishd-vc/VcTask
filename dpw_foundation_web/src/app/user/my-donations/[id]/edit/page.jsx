import Donation from 'src/components/_admin/my-donations/donation';

// Meta information
export const metadata = {
  title: 'My Donations| DP World Foundation',
  description:
 ...
 *
 * This page displays the donation management section of the DPW Foundation Dashboard.
 * It uses the `Donation` component to handle donation-related actions, with the
 * `isView` prop set to `false` to allow donations to be managed, but not viewed.
 */
export default function page() {
  return <Donation isView={false} />;
}

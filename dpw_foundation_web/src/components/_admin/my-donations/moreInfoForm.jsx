 ...
 */
const MoreInfoForm = ({ open, onClose, onSubmit, isLoading, id }) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      value.status = 'DONOR_MORE_INFO_REQUIRED';
  ...
  const handleAttachmentsUpload = async (file) => {
    const result = await api.uploadNeedMoreInfo(id, 'normal', file); // Call the API to upload the file

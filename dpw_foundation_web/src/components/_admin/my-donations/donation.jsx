...
import DonationForm from './donationForm'; // Import the DonationForm component for creating or editing donations
...
const Donation = ({ isView }) => {
  ...
  return (
    <>
      {isView ? (
        <DonationView data={detail} loading={isLoading} isAccept={false} isView={isView} />
      ) : (
        <DonationForm data={detail} loading={isLoading} refetch={refetch} isView={isView} />
      )}
    </>
  );
};
...
export default Donation; // Export the Donation component for use in other parts of the application

...
export default function BankingInformation({ data, loading }) {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6}>
          {data?.bankBeneficiaryName ? (
            ...
            <FieldWithSkeleton isLoading={loading} error={touched.bankBeneficiaryName && errors.bankBeneficiaryName}>
              <TextField
        ...
        <Grid item xs={12} sm={6}>
          {data?.bankName ? (
            ...
            <FieldWithSkeleton isLoading={loading} error={touched.bankName && errors.bankName}>
              <TextField
                id="bankName"
                variant="standard"
                fullWidth
        ...
        <Grid item xs={12} sm={6}>
          {data?.bankAccount ? (
            ...
            <FieldWithSkeleton isLoading={loading} error={touched.bankAccount && errors.bankAccount}>
              <TextField
                id="bankAccount"
                variant="standard"
                fullWidth
        ...
        <Grid item xs={12} sm={6}>
          {data?.bankIban ? (
            ...
            <FieldWithSkeleton isLoading={loading} error={touched.bankIban && errors.bankIban}>
              <TextField
                id="bankIban"
                variant="standard"
                fullWidth
        ...
        <Grid item xs={12} sm={6}>
          {data?.bankSwiftCode ? (
            ...
            <FieldWithSkeleton isLoading={loading} error={touched.bankSwiftCode && errors.bankSwiftCode}>
              <TextField
                id="bankSwiftCode"
                variant="standard"
                fullWidth

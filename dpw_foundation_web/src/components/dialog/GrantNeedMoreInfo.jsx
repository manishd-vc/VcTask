...
export default function GrantNeedMoreInfo({ open, onClose, stageType, data, backTo }) {
  ...
  const { mutate: deleteMediaMutation, isLoading: isDeleteLoading } = useMutation(
    'deleteMedia',
    grantManagementApi.deleteNeedMoreInfoDocuments,
    {
      onSuccess: (response) => {
  ...
  const { mutate, isLoading, isSuccess } = useMutation(grantManagementApi.uploadNeedMoreInfoDocuments, {
    onSuccess: (response) => {
      dispatch(setToastMessage({ message: response.message, variant: 'success' }));
  ...
  const { mutate: grantCommonStatusUpdate, isLoading: isGrantCommonStatusUpdateLoading } = useMutation(
    ...
    <Dialog aria-label="Upload-documents" onClose={onClose} open={open} maxWidth={'md'}>
      ...
      <Formik
        ...
        onSubmit={(values) => {
          ...
          grantCommonStatusUpdate({ id: data?.id, payload });
        }}
      >
            ...
            <Form id="needMoreInfoForm">
              ...
              <DialogActions>
                ...
                <LoadingButton
                  ...
                  loading={isGrantCommonStatusUpdateLoading}
                  disabled={!dirty}
                >
                  Send
                </LoadingButton>

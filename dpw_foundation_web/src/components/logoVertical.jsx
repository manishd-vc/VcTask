...
export const LogoVertical = () => {
  ...
  return (
    ...
    >
      ...
      {/* <Image draggable="false" src={logoVertical} alt="DPW Foun" static sizes="200px" objectFit="cover" /> */}
      <Image draggable="false" src={logoVertical} alt="DPW Foun" sizes="200px" style={{ objectFit: 'cover' }} />
    </Box>
  );
};
